...
console.error(err)
		...
		const isQuotedAudio = isQuotedMsg ? content.includes('audioMessage') ? true : false : true
		const isQuotedDocument = isQuotedMsg ? content.includes('documentMessage') ? true : false : false
		const isQuotedVideo = isQuotedMsg ? content.includes('videoMessage') ? true : false : true
		const isQuotedSticker = isQuotedMsg ? content.includes('stickerMessage') ? true : false : true
...
"thumbnail": ppnyauser,
"previewType": "VIDEO",
"mediaUrl": 'https://youtu.be/PrX_de1yRkI',
...
var button = [
{"urlButton": {"displayText": "GC BOT 🔥","url": `https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW`}},
{"urlButton": {"displayText": "My Owner🔥","url": `https://wa.me/6287705048235`}},
{"quickReplyButton": {"displayText": "Sewabot ☕","id": 'sewabot'}},
{"quickReplyButton": {"displayText": "Donasi 😁","id": 'donasi'}},
{"quickReplyButton": {"displayText": "Status Bot Hentongers 👤","id": 'ping'}}
		]
...
"previewType": "VIDEO",
"mediaUrl": 'https://youtu.be/PrX_de1yRkI',
"sourceUrl": 'https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW'}}}, {quoted: m, caption: `Jangan Malas Kak...`})
})
}
break
case 'nuliskanan':{
...
teks = '*List Banned*\n\n'
for (let kirbotz of ban) {
teks += `- ${kirbotz}\n`
}
teks += `\n*Total : ${ban.length}*`
kirbotz.sendMessage(from, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": ban } })
break
case 'ban':
...
hydratedFooterText: 'Created By Hentongers',
hydratedButtons: [{
urlButton: {
displayText: 'My Owner',
url: 'wa.me/6289688206739'
}
},
{
urlButton: {
displayText: 'GC BOT 🔥',
url: 'https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW'
}
},
...
{
"title": `ALL MENU 🔥`,
"description": `Menampilkan Semua Menu/Fitur ⚡`,
...
{
"title": `Image Hentai 🤤`,
"description": `Menampilkan Image Hentai 🤤`,
"rowId": `${prefix}nsfwww`
}
]
}
...
"rowId": `${prefix}ownerrr`
}
]
}
,
{
"title":"━━━━━━━━━━━━━━━[𝗥𝗔𝗡𝗗𝗢𝗠 𝗖𝗘𝗥𝗜𝗧𝗔 𝗠𝗘𝗡𝗨]━━━━━━━━━━━━━━━━━",
 rows: [
{
"title": `Menu Random Cerita 😬`,
"description": `Menampilkan Menu Random Cerita 😬`,
"rowId": `${prefix}ceritaaa`
}
]
}
,
...
,
{
"title":"━━━━━━━━━━━━━━━[𝗧𝗢𝗣 𝗨𝗣 𝗗𝗜𝗔𝗠𝗢𝗡𝗗]━━━━━━━━━━━━━━━━━",
 rows: [
{
"title": `Menu Top Up Diamond 💎`,
"description": `Menampilkan Menu Top Up Diamond 💎`,
"rowId": `${prefix}topuppp`
}
]
}
,
...
{
"title": `Menu Other 🗞️`,
"description": `Menampilkan Menu Other 🗞️`,
"rowId": `${prefix}otherrr`
}
]
}
,
...
kirbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "➡️ CLICK ⬅️", "Menu Bot By Hentongers ", sectionnyaaa, { quoted: fakekirbotz})
break
...
┌──『 ${ya}Image Hentai${ya} 』
│ ${ya}${Yy+=1} ${prefix}waifu
│ ${ya}${Yy+=1} ${prefix}loli
│ ${ya}${Yy+=1} ${prefix}milf
│ ${ya}${Yy+=1} ${prefix}chiisaihentai
│ ${ya}${Yy+=1} ${prefix}trap
│ ${ya}${Yy+=1} ${prefix}blowjob
│ ${ya}${Yy+=1} ${prefix}Gambang
│ ${ya}${Yy+=1} ${prefix}yaoi
│ ${ya}${Yy+=1} ${prefix}ecchi
│ ${ya}${Yy+=1} ${prefix}ahegao
│ ${ya}${Yy+=1} ${prefix}hololewd
│ ${ya}${Yy+=1} ${prefix}sideoppai
│ ${ya}${Yy+=1} ${prefix}animefeets
│ ${ya}${Yy+=1} ${prefix}animebooty
│ ${ya}${Yy+=1} ${prefix}animethighss
│ ${ya}${Yy+=1} ${prefix}hentaiparadise
│ ${ya}${Yy+=1} ${prefix}animearmpits
│ ${ya}${Yy+=1} ${prefix}hentaifemdom
│ ${ya}${Yy+=1} ${prefix}lewdanimegirls
│ ${ya}${Yy+=1} ${prefix}biganimetiddies
│ ${ya}${Yy+=1} ${prefix}animebellybutton
│ ${ya}${Yy+=1} ${prefix}hentai4everyone
│ ${ya}${Yy+=1} ${prefix}bj
│ ${ya}${Yy+=1} ${prefix}ero
│ ${ya}${Yy+=1} ${prefix}cum
│ ${ya}${Yy+=1} ${prefix}feet
...
│ ${ya}${Yy+=1} ${prefix}kuni
│ ${ya}${Yy+=1} ${prefix}erok
│ ${ya}${Yy+=1} ${prefix}solog
│ ${ya}${Yy+=1} ${prefix}feetg
│ ${ya}${Yy+=1} ${prefix}lewdk
│ ${ya}${Yy+=1} ${prefix}pussy
│ ${ya}${Yy+=1} ${prefix}femdom
│ ${ya}${Yy+=1} ${prefix}hentai
│ ${ya}${Yy+=1} ${prefix}eroyuri
│ ${ya}${Yy+=1} ${prefix}cum_jpg
│ ${ya}${Yy+=1} ${prefix}erofeet
│ ${ya}${Yy+=1} ${prefix}holoero
│ ${ya}${Yy+=1} ${prefix}classic
│ ${ya}${Yy+=1} ${prefix}erokemo
│ ${ya}${Yy+=1} ${prefix}futanari
│ ${ya}${Yy+=1} ${prefix}lewdkemo
│ ${ya}${Yy+=1} ${prefix}pussy_jpg
│ ${ya}${Yy+=1} ${prefix}nsfw_avatar
└──────`)}
break
...
const botzkir = "6289688206739@s.whatsapp.net"
...
Saya Hentongers-Botz 😎 Saya Disini Ingin Membantu Kalian 🤗 Membuat Sticker Download Video/Lagu Youtube, Tiktok Dll 😁 Dan Juga Gunakan Dengan Bijak Bot Saya Ini Tolong Jangan Spam 🤬 Ketahuan Spam Oleh Saya Auto Block 😏.`
let buttons = [
{buttonId: `${prefix}rpgmenu`, buttonText: {displayText: '⚔️ RPG MENU ⚔️'}, type: 1},
{buttonId: `${prefix}runtime`, buttonText: {displayText: '🤖 RUN TIME BOT 🤖'}, type: 1},
{buttonId: `${prefix}allmenu`, buttonText: {displayText: '🔥 ALL MENU 🔥'}, type: 1}

]
let buttonMessage = {
document: fs.readFileSync('./Image/memeknya.jpg'), 
fileName: `Bot By Hentongers`, 
...
│ ${ya}${Yy+=1} ${prefix}feet${ya}
│ ${ya}${Yy+=1} ${prefix}yuri${ya}
│ ${ya}${Yy+=1} ${prefix}trap${ya}
│ ${ya}${Yy+=1} ${prefix}lewd${ya}
│ ${ya}${Yy+=1} ${prefix}eron${ya}
│ ${ya}${Yy+=1} ${prefix}solo${ya}
│ ${ya}${Yy+=1} ${prefix}anal${ya}
│ ${ya}${Yy+=1} ${prefix}tits${ya}
│ ${ya}${Yy+=1} ${prefix}kuni${ya}
│ ${ya}${Yy+=1} ${prefix}erok${ya}
│ ${ya}${Yy+=1} ${prefix}solog${ya}
│ ${ya}${Yy+=1} ${prefix}feetg${ya}
│ ${ya}${Yy+=1} ${prefix}lewdk${ya}
│ ${ya}${Yy+=1} ${prefix}waifu${ya}
│ ${ya}${Yy+=1} ${prefix}pussy${ya}
│ ${ya}${Yy+=1} ${prefix}femdom${ya}
│ ${ya}${Yy+=1} ${prefix}eroyuri${ya}
│ ${ya}${Yy+=1} ${prefix}cum_jpg${ya}
│ ${ya}${Yy+=1} ${prefix}erofeet${ya}
│ ${ya}${Yy+=1} ${prefix}holoero${ya}
│ ${ya}${Yy+=1} ${prefix}classic${ya}
│ ${ya}${Yy+=1} ${prefix}erokemo${ya}
│ ${ya}${Yy+=1} ${prefix}futanari${ya}
│ ${ya}${Yy+=1} ${prefix}lewdkemo${ya}
│ ${ya}${Yy+=1} ${prefix}pussy_jpg${ya}
│ ${ya}${Yy+=1} ${prefix}nsfw_avatar${ya}
│ ${ya}${Yy+=1} ${prefix}hentai${ya}
...
│ ${ya}${Yy+=1} ${prefix}gimage2${ya}
│ ${ya}${Yy+=1} ${prefix}pixiv${ya}
│ ${ya}${Yy+=1} ${prefix}pixiv2${ya}
...
kirbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By Hentongers`, global.thumb, btn)
}
break
...
kirbotz.send5ButImg(i, junn, `Created By Hentongers`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
kirbotz.send5Vid(i, junn, `Created By Hentongers`, buffer, butoon)
...
let btn = [{
                      ...
                      kirbotz.send5Vid(m.chat, `S U C C E S ✅`, kirbotz.user.name, hasiltt, btn)
                      }
                      break
case 'hentai':
case 'loli':
...
sticWait(from)
hasil = await getBuffer(`https://api.lolhuman.xyz/api/random2/nsfw2/${command}?apikey=${lolkey}`)
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: hasil }, { upload: kirbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
...
"previewType": "VIDEO",
"mediaUrl": 'https://youtu.be/PrX_de1yRkI',
"sourceUrl": 'https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW'}}}, { quoted: fakekirbotz })
fs.unlinkSync(ran)
})
}
break
...
kirbotz.sendMessage(m.chat, {document: mnya, mimetype: 'application/zip', fileName: `${kfeh.result.filename}`}, {quoted:fakekirbotz}).catch ((err) => reply(oh))
}
break
case 'iqra': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    query = args.join(" ")
                    ini_url = await fetchJson(`https://api.lolhuman.xyz/api/gimage?apikey=${lolkey}&query=${query}`)
                    ini_url = ini_url.result
                    ini_buffer = await getBuffer(ini_url)
                    await kirbotz.sendMessage(m.chat, { image: ini_buffer, caption: '*GIMAGE IMAGE*' }, { quoted: m})                  
                    break
case 'gimage2':
case 'image2':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} loli kawaii`)
                    query = args.join(" ")
                    dwxwdwww = await fetchJson(`https://api.lolhuman.xyz/api/gimage2?apikey=${lolkey}&query=${query}`)
                    sticWait(from)
                    vdcdnsss = dwxwdwww.result
                    for (var x = 0; x <= 5; x++) {
                        var ini_buffer = await getBuffer(vdcdnsss[x])
...
sticWait(from)
                    query = args.join(" ")
                    ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pixiv?apikey=Atakbotz&query=${query}`)
                    ini_url = ini_url.result
                    ini_buffer = await getBuffer(ini_url)
                    await kirbotz.sendMessage(m.chat, { image: ini_buffer, caption: '*IMAGE IMAGE*' }, { quoted: m})                  
                    break                    
case 'pinterest':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    query = args.join(" ")
                    ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=Atakbotz&query=${query}`)
                    ini_url = ini_url.result
                    ini_buffer = await getBuffer(ini_url)
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
                    ...
                    sticWait(from)
                    query = args.join(" ")
                    dwxwdw = await fetchJson(`https://api.lolhuman.xyz/api/pinterest2?apikey=Atakbotz&query=${query}`)
...
sticWait(from)
let res = await caliph.downloader.tiktok(args[0])
kirbotz.sendMessage(from, { audio: { url: res.audio }, mimetype: 'audio/mp4', ptt:true, contextInfo:{externalAdReply:{
showAdAttribution: true,
title: `Hai Kak ${pushname}`,
...
{ quickReplyButton: { displayText: 'AUDIO 🎵', id: `${prefix}tiktokaudio ${args[0]}` } }]
}
}
}), { userJid: m.chat, quoted: m })
kirbotz.relayMessage(m.chat, template.message, { messageId: template.key.id })
...
kirbotz.sendMessage(m.chat, { image: { url: random }, caption: `S U C C E S ✅` }, { quoted: m })
}
break
...
kirbotz.sendMessage(m.chat, { image: { url: random }, caption: `S U C C E S ✅` }, { quoted: fakekirbotz })
}
break
case 'wallpaperinori':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
hydratedTemplate: {
imageMessage: message.imageMessage,
hydratedContentText: `S U C C E S ✅`,
hydratedFooterText: 'Created By Hentongers',
hydratedButtons: [{
urlButton: {
displayText: 'My Owner',
